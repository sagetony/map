...
const GridMap = () => {
  ...
  const sections = [
    { id: 1, startRow: 1, endRow: 5, startCol: 1, endCol: 25 },
    { id: 2, startRow: 1, endRow: 5, startCol: 26, endCol: 50 },
    ...
    { id: 7, startRow: 6, endRow: 15, startCol: 67, endCol: 100 },
    { id: 8, startRow: 16, endRow: 30, startCol: 1, endCol: 25 },
    { id: 9, startRow: 16, endRow: 30, startCol: 26, endCol: 50 },
    { id: 10, startRow: 16, endRow: 30, startCol: 51, endCol: 75 },
    { id: 11, startRow: 16, endRow: 30, startCol: 76, endCol: 84 },
    { id: 11, startRow: 16, endRow: 30, startCol: 85, endCol: 100 },
  ];
